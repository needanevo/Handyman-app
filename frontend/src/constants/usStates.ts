/**
 * US States for address form dropdowns.
 * Normalized to 2-letter abbreviations for consistent storage.
 * Supports future address verification providers (Radar, SmartyStreets, etc.)
 */
