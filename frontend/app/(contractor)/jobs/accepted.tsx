 ...
 *
 * Shows jobs that contractor has accepted but not yet scheduled.
...
export default function AcceptedJobs() {
  ...
  // Fetch accepted jobs using unified query key (matches dashboard)
        ...
        <EmptyState
          ...
          message={
            searchQuery
              ...
              : "Jobs you accept will appear here. Schedule them to begin work."
          }
        />
      ) : (
        <FlatList
