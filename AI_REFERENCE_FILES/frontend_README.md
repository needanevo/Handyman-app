...
- **[Color Schemes To Use] (./AI_REFERENCE_FILES/Color_Schemes/sea.html)** - Check this file and the others in this folder. Redesign with these color schemes and lose the all orange look. Keep the background white.
