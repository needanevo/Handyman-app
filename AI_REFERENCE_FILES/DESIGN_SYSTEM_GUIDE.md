...
```typescript
colors.primary.main      // #E88035 - Kinder (from a_slow_uncovering.html)
colors.primary.light     // #FFA96B - Hello Meows (from a_slow_uncovering.html)
colors.primary.dark      // #C26A2C
colors.primary.lighter   // #FADDCB
colors.primary.lightest  // #FEF3ED
```

### Secondary Actions & Energy
```typescript
colors.secondary.main    // #2D8691 - Undressed (from a_slow_uncovering.html)
colors.secondary.light   // #B3F2CC - Sea foam (from sea.html)
colors.secondary.dark    // #246B72
colors.secondary.lighter // #D1F0F2
colors.secondary.lightest// #F0FAFA
```

### Status Colors
```typescript
colors.success.main      // #CCE699 - Baby leaves (from sea.html)
colors.warning.main      // #FFCC33 - Sunset (from sea.html)
colors.error.main        // #FF776B - Burnt (from a_slow_uncovering.html)
```
